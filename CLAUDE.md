...
- 2026-07-18 16:15 CET - Claude - Added `services/signals`, a standalone situational-awareness feed ported from a prior project, reached only through an additive gateway route and its own cockpit page. Never touches the claim pipeline or the Twin (D-0018, B-9).
