...
- 2026-07-18 15:00 CET - Claude - Added `signals.ts`: region, criticality, relevance, raw-item, and event schemas for the new standalone signals service. Not part of the Twin (D-0022).
