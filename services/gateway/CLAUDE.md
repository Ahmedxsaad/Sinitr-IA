...
- 2026-07-18 15:00 CET - Claude - Added a `GET /api/signals` read-through to the new standalone signals service, gated like the other adjuster routes. Holds no signals logic itself, matching the gateway's aggregation-only boundary (D-0022).
